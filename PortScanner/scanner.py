...
def main(host: str, start: int, end: int, tcp, udp):
...
def execute(scanner: Scanner, port: int, tcp, udp):
    if tcp:
...
if __name__ == "__main__":
    args = Args()
    main(args.host, args.start, args.end, args.t, args.u)
